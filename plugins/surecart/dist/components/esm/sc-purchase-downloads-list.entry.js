...
const ScPurchaseDownloadsList = class {
    ...
    render() {
        return (h("sc-dashboard-module", { key: 'ee8392245f6a45bfd93f30318f5784afed1f26a5', class: "downloads-list", error: this.error }, h("span", { key: '5b4404db99610a80fdfea36e855e6c7f6964b500', slot: "heading" }, h("slot", { key: '4a2d16a0bea06d1585bf4007efa88f2fae06082e', name: "heading" }, this.heading || wp.i18n.__('Items', 'surecart'))), h("slot", { key: '228e65821bf75d7b7e7c2ffc3de7530c2be55554', name: "before" }), !!this.allLink && (h("sc-button", { key: '75598c02ef6bd92263aeaa34873abcfc7f99876b', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: 'af2ec3a2fa00b3d7dc3eac3932ead08aba7c7aca', name: "chevron-right", slot: "suffix" }))), this.renderContent(), h("slot", { key: '3128870af4cd81f28e25dd0a3f3220fa03859cba', name: "after" }), this.busy && h("sc-block-ui", { key: '5dc26eaeb5c4389faf05247419b67041d5b41896' })));
    }
